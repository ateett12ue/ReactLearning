...
class Contact extends Component {
    ...
    render(){
        ...
        {/*as for can be confused with for of js*/}
                                <Col md={10}>
                                    <Input type="text" id="firstname" name="firstname" placeholder="First Name" value={this.state.firstname} onChange={this.handleInputChange} onBlur={this.handleBlur('firstname')} valid={errors.firstname === ''} invalid={errors.firstname !==''} required></Input>
                                    <FormFeedback>
                                        {errors.firstname}
                                    </FormFeedback>
                                </Col>
        ...
        {/*as for can be confused with for of js*/}
                                <Col md={10}>
                                    <Input type="text" id="lastname" name="lastname" placeholder="Last Name" value={this.state.lastname} onChange={this.handleInputChange} onBlur={this.handleBlur('lastname')} valid={errors.lastname === ''} invalid={errors.lastname !==''}></Input>
                                    <FormFeedback>
                                        {errors.lastname}
                                    </FormFeedback>
                                </Col>
