    ...
    render(){
        ...
        {/*as for can be confused with for of js*/}
                                <Col md={10}>
                                    ...
                                    <Errors className="text-danger" model=".telnum" show="touched" messages={{required: 'Required', minLength: 'Must be greater than 2 characters', maxLength: 'Must be 15 characters or less', isNumber: 'Input can be Number only' }}/>
        ...
        {/*as for can be confused with for of js*/}
                                <Col md={10}>
                                    <Control.text model=".email" id="email" name="email" placeholder="Email" className="form-control" validators={{
                                        required, validEmail}}></Control.text>
